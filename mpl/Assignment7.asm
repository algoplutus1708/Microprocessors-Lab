; Write X86/64 ALP to perform non-overlapped block transfer with & without string specific instructions.
; 17 May 2021
...
section .data
	...
	problem_statement db 10, " Write X86/64 ALP to perform non-overlapped block transfer with & without string specific instructions."
	...
	destination_block times 5 dq 00H
...
section .bss
	...
	source_block resq 5			; Source block storing 5 64-bit Hexadecimal numbers
